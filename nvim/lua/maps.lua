...
map({ "n", "i" }, "<c-s>", "<cmd>w!<cr>", { desc = "Save buffer" })
map({ "n", "i" }, "<a-s>", "<cmd>w!<cr><cmd>stopinsert<cr>", { desc = "Save buffer" })
map("i", "jk", "<cmd>stopinsert<cr>", { desc = "Exit insert mode" })
...
map("n", "cn", '<cmd>norm! f"lf"lci"<cr>a', { desc = "Change next item in quotes" })
...
map("n", "<a-p>", "<cmd>Lspsaga goto_definition<cr>", { desc = "Goto definition" })
map("n", "<s-t>", "<cmd>Lspsaga peek_type_definition<cr>", { desc = "Peek type definition" })
map("n", "<a-t>", "<cmd>Lspsaga goto_type_definition<cr>", { desc = "Goto type definition" })
